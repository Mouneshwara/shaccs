...
<div class="col-lg-12 col-md-12 col-sm-12  text-center feature-icon">
                                <img src="<?php echo site_url(); ?>/wp-content/uploads/2018/04/3rd.png" alt="">
                            </div>
                            <br> <br> <br>
...
$args = array( 'post_type' => 'affilate', 'posts_per_page' => 10000 ,'order'=>'ASC');
...
<div class="row">
                <article class="two-col-service1 post-110 service type-service status-publish has-post-thumbnail hentry">
                    ...
                    <img style="width: 100%; height: 100%;" width="400" height="200" src="<?php echo $featured_img_url; ?>" class="attachment-service-gallery-thumb size-service-gallery-thumb wp-post-image" alt="" srcset="<?php echo $featured_img_url; ?> 848w, <?php echo $featured_img_url; ?> 300w, <?php echo $featured_img_url; ?> 732w, <?php echo $featured_img_url; ?> 111w" sizes="(max-width: 848px) 100vw, 848px">                </a>  <?php  ?>
                    </figure>
                    </div>
