...
if( function_exists('acf_add_options_page') ) {
 ...
 $args = array(
    ...
    register_post_type( 'home_blog', $args );
}
...
// 	register_post_type( 'home_blog',
//     array(
//       'labels' => array(
//         'name' => __( 'Home Blog' ),

//         'singular_name' => __( 'Home Blog' )
//       ),
//       'public' => true,
//       'has_archive' => true,
...
function m1_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'm1_logo', array(
        'label'    => __( 'Upload Sticky Header Logo', 'm1' ),
...
$wp_customize->add_control( 'themeslug_text_setting_id', array(
 ...
 $wp_customize->add_setting( 'themeslug_text_setting_id1', array(
  'capability' => 'edit_theme_options',
  'default' => '',
  'sanitize_callback' => 'sanitize_text_field',
) );

$wp_customize->add_control( 'themeslug_text_setting_id1', array(
 'type' => 'number',
  'section' => 'title_tagline', // Add a default or your own section
 ...
 $wp_customize->add_setting( 'themeslug_text_setting_id2', array(
  'capability' => 'edit_theme_options',
  'default' => '',
  'sanitize_callback' => 'sanitize_text_field',
) );

$wp_customize->add_control( 'themeslug_text_setting_id2', array(
 'type' => 'textarea',
  'section' => 'title_tagline', // Add a default or your own section
  'label' => __( 'Footer About Shaccs' ),
  'description' => __( 'Footer About Shaccs' ),
) );
